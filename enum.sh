...
cat $SUBDOMAIN_PATH/responsive.txt  | sed 's/\http\:\/\///g' |  sed 's/\https\:\/\///g' | sort -u | tee -a  $SUBDOMAIN_PATH/responsive.txt
cat  $SUBDOMAIN_PATH/responsive.txt | sort -u | grep -m 1 $line | tee -a  $SUBDOMAIN_PATH/urllist.tx 
