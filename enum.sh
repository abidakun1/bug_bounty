...
cat $SUBDOMAIN_PATH/found_subdomain.txt | httpx-toolkit -mc 200 > $SUBDOMAIN_PATH/alive.txt
cat $SUBDOMAIN_PATH/found_subdomain.txt | httpx-toolkit -title -tech-detect -status-code > $SUBDOMAIN_PATH/techdete>
